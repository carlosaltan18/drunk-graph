...
export const AppHeader: React.FC<AppHeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-[#09090b] border-b border-[#27272a] px-5 h-14 flex items-center justify-between">
      <div className="flex items-center gap-3">
        ...
        {showLogo && (
          <div className="flex items-center gap-2">
            ...
            <span
              className="font-black text-base tracking-tighter uppercase text-white leading-none"
              style={{
        ...
        {title && (
          <h1 className="text-sm font-black text-zinc-300 uppercase tracking-widest ml-1">
            {title}
          </h1>
        )}
      </div>
