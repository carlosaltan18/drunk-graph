...
const AdminSessionBar = ({ userEmail }: { userEmail: string }) => {
  ...
  return (
    <header className="sticky top-0 z-50 h-12 bg-zinc-900 border-b border-zinc-800 flex items-center justify-between px-6">
...
const VenuePreview = ({
  ...
  return (
    <div className="relative p-6 rounded-2xl border-2 border-dashed border-amber-400/20 bg-zinc-900/50 overflow-hidden">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div>
          <h4 className="text-xl font-bold text-white uppercase tracking-tight truncate">
            {displayName}
          </h4>
...
export const CreateVenuePage = ({ userEmail }: Props) => {
  ...
  return (
    <div className="min-h-screen w-full bg-zinc-950 font-sans text-zinc-100 selection:bg-amber-400/30">
      ...
      <main className="max-w-7xl mx-auto px-8 py-16">
        ...
        <header className="mb-16">
          <motion.h1
            ...
            className="text-7xl lg:text-8xl font-black text-white uppercase tracking-tighter leading-none"
          >
            Create <br /> Venue
          </motion.h1>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          <section className="lg:col-span-7">
            <motion.div
              ...
              className="bg-zinc-900 border border-zinc-800 rounded-3xl p-10 shadow-2xl"
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-10">
                <div className="space-y-3 group">
                  <label
                    htmlFor="name"
                    className="block text-[10px] font-bold text-zinc-400 uppercase tracking-widest group-focus-within:text-amber-400 transition-colors"
                  >
                    Venue Name
                  </label>
                  <input
                    ...
                    placeholder="e.g. Club Gallo Negro"
                    required
                    className="w-full bg-zinc-800 border border-zinc-700 rounded-2xl px-6 py-5 text-xl font-bold text-white placeholder:text-zinc-600 focus:outline-none focus:border-amber-400 focus:ring-4 focus:ring-amber-400/10 transition-all"
                  />
                ...
                <div className="space-y-3 group">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder="e.g. Zona 10, Guatemala City"
                    required
                    className="w-full bg-zinc-800 border border-zinc-700 rounded-2xl px-6 py-5 text-xl font-bold text-white placeholder:text-zinc-600 focus:outline-none focus:border-amber-400 focus:ring-4 focus:ring-amber-400/10 transition-all"
                  />
                  <div className="flex items-center gap-1.5 px-1">
                ...
                <div className="pt-6 flex flex-col sm:flex-row gap-4">
                  <button
                    ...
                    className={cn(
                      "flex-1 bg-amber-400 hover:bg-amber-300 text-black font-black uppercase tracking-widest py-5 px-8 rounded-2xl text-lg transition-all active:scale-[0.98] flex items-center justify-center gap-3 group",
                  ...
                  <button
                    type="button"
                    onClick={() => router.push("/admin/dashboard")}
                    className="bg-zinc-800 hover:bg-zinc-700 text-zinc-300 border border-zinc-700 hover:border-amber-400/40 font-bold uppercase tracking-widest py-5 px-8 rounded-2xl transition-all active:scale-[0.98]"
                  >
                    Cancel
                  </button>
                </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <VenuePreview
                    ...
                    location={formData.location}
                  />
                  <p className="mt-4 text-[10px] font-medium text-zinc-600 italic px-1">
                    This is how it will appear on your venue list.
                  </p>
                </div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={step} className="flex gap-4 items-start group">
                        ...
                        <p className="text-xs font-medium text-zinc-400 group-hover:text-zinc-300 transition-colors pt-1">
                          {step}
                        </p>
                      </div>
                    ))}
